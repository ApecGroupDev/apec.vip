    ...
    <div className="max-w-7xl mx-auto px-6 py-20 space-y-28">
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-16">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center transform hover:scale-105 transition-transform duration-300 hover:shadow-lg">
            ...
            <button className="bg-[#e82228] text-white py-2 px-6 rounded-full font-medium shadow-md hover:bg-red-800 transition-all duration-300">
              Learn More
            </button>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center transform hover:scale-105 transition-transform duration-300 hover:shadow-lg">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Stay compliant and sustainable with our expert environmental solutions tailored to your business needs and personal wants.
            </p>
            <button className="bg-[#e82228] text-white py-2 px-6 rounded-full font-medium shadow-md hover:bg-red-800 transition-all duration-300">
              Discover More
            </button>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center transform hover:scale-105 transition-transform duration-300 hover:shadow-lg">
            ...
            <button className="bg-[#e82228] text-white py-2 px-6 rounded-full font-medium shadow-md hover:bg-red-600 transition-all duration-300">
              Learn More
            </button>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center transform hover:scale-105 transition-transform duration-300 hover:shadow-lg">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Maximize and modernize efficiency and track fuel usage with our cutting-edge fuel management systems.
            </p>
            <button className="bg-[#e82228] text-white py-2 px-6 rounded-full font-medium shadow-md hover:bg-red-600 transition-all duration-300">
              Discover More
            </button>
